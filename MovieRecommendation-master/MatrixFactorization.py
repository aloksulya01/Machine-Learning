...
def build_movies_dict(moviesfile):
    i = 0
    movie_id_dict = {}
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 4:
        ...
        movies_mapping_file = sys.argv[5]
        ...
        numpy_arr = read_data(ratings_file);
        #main function
